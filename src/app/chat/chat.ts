...
export class Chat {
  ...
  messages = signal<ChatMessage[]>([
    {
      role: 'user',
      content: ['¿Cuáles son las proyecciones de ingresos para el tercer trimestre según los documentos analizados?'],
      time: 'You • 10:42 AM',
    },
    {
      role: 'ai',
      ...
      citations: [
        { label: 'Análisis Trimestral (Pag. 12)' },
        { label: 'Estrategia Crecimiento (Sec. 4)' },
      ],
    },
    {
      role: 'user',
