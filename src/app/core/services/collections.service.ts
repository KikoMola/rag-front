...
export class CollectionsService {
    ...
    getDocuments(collectionId: number): Observable<CollectionDocument[]> {
        return this.http.get<CollectionDocument[]>(`${API_BASE}/collections/${collectionId}/documents`);
    }

    getDocumentStatus(collectionId: number, documentId: number): Observable<CollectionDocument> {
        return this.http.get<CollectionDocument>(`${API_BASE}/collections/${collectionId}/documents/${documentId}`);
    }
    ...
    uploadDocuments(collectionId: number, files: File[]): Observable<CollectionDocument[]> {
        ...
        return this.http.post<CollectionDocument[]>(`${API_BASE}/collections/${collectionId}/documents`, formData);
    }

    deleteDocument(collectionId: number, documentId: number): Observable<void> {
        return this.http.delete<void>(`${API_BASE}/collections/${collectionId}/documents/${documentId}`);
    }
}
